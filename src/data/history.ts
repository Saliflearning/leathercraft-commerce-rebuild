...
export const historicalPhases: readonly HistoricalPhase[] = [
  {
    ...
    verifiedCapabilities: [
      'Multi-page HTML/CSS storefront concept',
      'Expanded visual/catalog iteration',
    ],
    limitations: [
      'No backend, search, cart, account, or purchase flow',
      'Exact course submission unresolved',
    ],
  ...
  },
  {
    ...
    lesson:
      'Feature breadth without secure data handling, tests, and ownership clarity is not production readiness.',
  ...
  },
  {
    ...
    verifiedCapabilities: [
      ...
      'Figma prototype',
      'Commerce-platform redesign and reflection',
    ],
    limitations: [
      'No complete final repository',
      'Current host is not a verified working deployment',
      'Asset and business permissions remain unresolved',
    ],
    lesson:
      'Better design process improved the concept, but durable engineering evidence was still missing.',
    evidenceStatus: 'verified',
  },
] as const;
...
export const evidenceNotes: readonly EvidenceNote[] = [
  ...
  },
  {
    ...
    classification: 'verified',
    claim:
      'The evidence preserves separate final 53/60, staged rubric 83/100, and final-project group 108/125 surfaces.',
  ...
  },
  {
    ...
    boundary:
      'The first and second database prototypes are credited to teammates; certainty is not claimed.',
  },
  {
    id: 'new-work-boundary',
    classification: 'new-work',
    claim:
      'All code, product data, diagrams, illustrations, tests, and prose in this repository are new reconstruction work.',
  ...
  },
  {
    ...
    claim:
      'No checkout, payment, customer, order, revenue, deployment, or production-security claim is made.',
